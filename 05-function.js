...
const sentence = "hello bandung"
function convToUpperCase(string) {
   return string.charAt(0).toUpperCase() + string.slice(1);
}
console.log("capitalized :",convToUpperCase(sentence));
...
function firstNonRepeatedChar(string) {
  for (var i = 0; i < string.length; i++) {
    ...
    } else if (string.indexOf(c) == i && string.indexOf(c, i + 1) == -1) {
      return c;
    }
  }
  return " ";
