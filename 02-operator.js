...
const oneInString = "1";
const oneInNumber = 1;
const isSame = console.log(oneInString == oneInNumber);
...
const studentA = 75;
const studentB = 80;
const isHigher = console.log(studentA > studentB);
...
const final = console.log(oneInString === oneInNumber);
